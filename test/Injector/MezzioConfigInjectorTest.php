...
class MezzioConfigInjectorTest extends AbstractInjectorTestCase
{
    ...
    public function emptyConfiguration()
    {
        ...
        return [
            'fqcn-long-array'    => [MezzioConfigInjector::TYPE_CONFIG_PROVIDER, $fqcnLongArray],
            'global-long-array'  => [MezzioConfigInjector::TYPE_CONFIG_PROVIDER, $globallyQualifiedLongArray],
            'import-long-array'  => [MezzioConfigInjector::TYPE_CONFIG_PROVIDER, $importLongArray],
            'fqcn-short-array'   => [MezzioConfigInjector::TYPE_CONFIG_PROVIDER, $fqcnShortArray],
            'global-short-array' => [MezzioConfigInjector::TYPE_CONFIG_PROVIDER, $globallyQualifiedShortArray],
            'import-short-array' => [MezzioConfigInjector::TYPE_CONFIG_PROVIDER, $importShortArray],
        ];
        // @codingStandardsIgnoreEnd
    }
